...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CubeView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CubeView_t qt_meta_stringdata_CubeView = {
    {
QT_MOC_LITERAL(0, 0, 8) // "CubeView"
...
QT_INIT_METAOBJECT const QMetaObject CubeView::staticMetaObject = { {
    QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
    qt_meta_stringdata_CubeView.data,
    qt_meta_data_CubeView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CubeView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CubeView.stringdata0))
