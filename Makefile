#############################################################################
# Makefile for building: CubeSpinner
# Generated by qmake (3.1) (Qt 5.15.9)
# Project:  CubeSpinner.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile CubeSpinner.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CubeSpinner1.0.0
DISTDIR = /home/bradley/Code/qt-cube/.tmp/CubeSpinner1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		CubeSpinner.pro cubeview.h main.cpp \
		cubeview.cpp
QMAKE_TARGET  = CubeSpinner
DESTDIR       = 
TARGET        = CubeSpinner
...
Makefile: CubeSpinner.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		CubeSpinner.pro \
		shaders.qrc
	$(QMAKE) -o Makefile CubeSpinner.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents cubeview.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp cubeview.cpp $(DISTDIR)/
...
qrc_shaders.cpp: shaders.qrc \
		...
		vshader.glsl \
		fshader.glsl
	/usr/bin/rcc -name shaders shaders.qrc -o qrc_shaders.cpp
...
compiler_moc_header_make_all: moc_cubeview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_cubeview.cpp
moc_cubeview.cpp: cubeview.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/bradley/Code/qt-cube/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/bradley/Code/qt-cube -I/usr/include/qt -I/usr/include/qt/QtOpenGL -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/13.1.1 -I/usr/include/c++/13.1.1/x86_64-pc-linux-gnu -I/usr/include/c++/13.1.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/13.1.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/13.1.1/include-fixed -I/usr/include cubeview.h -o moc_cubeview.cpp
...
main.o: main.cpp cubeview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

cubeview.o: cubeview.cpp cubeview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cubeview.o cubeview.cpp

qrc_shaders.o: qrc_shaders.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_shaders.o qrc_shaders.cpp

moc_cubeview.o: moc_cubeview.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_cubeview.o moc_cubeview.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/CubeSpinner/bin || mkdir -p $(INSTALL_ROOT)/opt/CubeSpinner/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/CubeSpinner/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/CubeSpinner/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/CubeSpinner/bin/ 
